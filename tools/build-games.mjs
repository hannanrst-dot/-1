...
for (const f of files) {
  ...
  /* «'#'» تنها برای چسباندن به کار می‌رود و ایراد ندارد.
     نامزدِ رنگ: «#» به‌علاوهٔ ۲ تا ۸ نویسه که در آن‌ها «.» و «#» نباشد.
     این دو را کنار می‌گذاریم تا نقشه‌های اَسکی («#....S...#») نامزد
     نشوند، ولی خرابی‌هایی مثل «#eed храм» یا «#e8a…» همچنان گرفته شوند
     چون فاصله و حرفِ غیرِهگز در آن‌ها آزاد است. */
  const badCol = [...body.matchAll(/['"](#[^'"\n.#]{2,8})['"]/g)]
    .map((m) => m[1])
