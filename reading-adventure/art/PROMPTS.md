...
این بخش **لازم نیست**. شخصیت‌ها حالا با استخوان‌بندیِ واقعی کشیده می‌شوند: صورت و
پلک و ابرو دارند، نفس می‌کشند، دُم و روسری با تأخیر تاب می‌خورند، و نور از یک طرف
رویشان می‌افتد. اگر روزی خواستی به‌جای شکلِ کدی تصویرِ نقاشی‌شده بگذاری، این درِ پشتی
باز است — ولی آن تصویر دیگر انیمیت نمی‌شود و فقط سرِ جا می‌ایستد.
