...
import {
  ...
  Users, Truck, ShoppingCart, Boxes, BarChart3, Settings, PlusCircle, CalendarClock, FlaskConical, FileSpreadsheet, Clock,
} from "lucide-react";
...
export function MobileNav() {
  ...
  const moreItems = [
    ...
    { href: "/price-review", label: "قیمت‌های قدیمی", icon: Clock },
