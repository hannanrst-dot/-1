...
const TASKS = [
  ...
  { hour: 19, label: 'اذانِ مغرب و شام',    icon: 'moon',
    story: 'آفتاب دارد پشتِ بام‌ها می‌رود و بوی شام می‌آید.\nوقتِ اذانِ مغرب است — هفتِ بعدازظهر.' },
  { hour: 21, label: 'وقتِ خواب',           icon: 'bed',
    story: 'آخرین کارِ روز. عقربه را ببر به نُهِ شب\nو ببین روی نوارِ شبانه‌روز کجا می‌ایستد.' },
];
